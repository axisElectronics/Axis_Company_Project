...
struct su_settingMenu settingMenuArray[50] = {
      ...
      /* 1 */ { 11, "Scale Setup"                , SUB_MENU  , nullFunc/* This function define cordingly */ },
      /* 2 */ { 12, "Weighing Units"             , SUB_MENU  , nullFunc /* This function define cordingly */},
      /* 3 */ { 13, "Scale Information"          , 0         , nullFunc/* This function define cordingly */ },
      /* 4 */ { 14, "Printer Configration"       , 0         , nullFunc/* This function define cordingly */ },
      /* 5 */ { 15, "Calibration"                , SUB_MENU  , nullFunc/* This function define cordingly */ },
      /* 6 */ { 16, "Save as Default"            , 0         , nullFunc/* This function define cordingly */ },
      /* 7 */ { 17, "Restore Default"            , 0         , nullFunc/* This function define cordingly */ },
      /* 8 */ { 18, "Factory Default"            , 0         , nullFunc/* This function define cordingly */ },

      /* 1.1 */ { 100, "Weighing Mode"           , 0         , nullFunc/* This function define cordingly */ },
      /* 1.2 */ { 101, "Counting Mode"           , 0         , nullFunc/* This function define cordingly */ },
      /* 1.3 */ { 102, "Check Weighing"          , 0         , nullFunc/* This function define cordingly */ },
      /* 1.4 */ { 103, "Price Computing"         , 0         , nullFunc /* This function define cordingly */ },

      /* 2.1 */ { 110, "Clock Setup"             , 0         , nullFunc/* This function define cordingly */ },
      /* 2.2 */ { 111, "Auto Zero"               , 0         , nullFunc/* This function define cordingly */ },
      /* 2.3 */ { 112, "Stability Filter Setup"  , 0         , nullFunc/* This function define cordingly */ },
      /* 2.4 */ { 113, "COM1 Parameters"         , SUB_MENU  , nullFunc/* This function define cordingly */ },

      /* 3.1 */ { 120, "Kilogram(kg)"            , 0         , nullFunc/* This function define cordingly */ },
      /* 3.1 */ { 121, "Grams(gm)"               , 0         , nullFunc/* This function define cordingly */ },
      /* 3.1 */ { 122, "Tons(T)"                 , 0         , nullFunc/* This function define cordingly */ },
      /* 3.1 */ { 123, "Ounces(Oz)"              , 0         , nullFunc/* This function define cordingly */ },
      /* 3.1 */ { 124, "Pounds(lb)"              , 0         , nullFunc/* This function define cordingly */ },

      /* 5.1 */ { 150, "Capacity"                , 0         , nullFunc/* This function define cordingly */ },
      /* 5.1 */ { 151, "E value"                 , 0         , nullFunc/* This function define cordingly */ },
      /* 5.1 */ { 152, "Decimal"                 , 0         , nullFunc/* This function define cordingly */ },
      /* 5.1 */ { 153, "Calibrate"               , 0         , nullFunc/* This function define cordingly */ },


      /* 2.4.1 */ { 1130, "Baudrate"             , 0         , nullFunc/* This function define cordingly */ },
      /* 2.4.2 */ { 1131, "Data Bits"            , 0         , nullFunc/* This function define cordingly */ },
      /* 2.4.3 */ { 1132, "Parity"               , 0         , nullFunc/* This function define cordingly */ },
      /* 2.4.4 */ { 1133, "Stop Bits"            , 0         , nullFunc/* This function define cordingly */ },
      /* 2.4.5 */ { 1134, "Flow Control"         , 0         , nullFunc/* This function define cordingly */ },
...
void settings ::  settingPageInit( )
{
  ...
  strcpy( userSetting.scaleInfo[0], "Version : 2.11.11");
  strcpy( userSetting.scaleInfo[1], "Serial# : 20452/3032");
}
...
int8_t settings :: handleENTButton(  )
{
  ...
  {
    if ( settingMenuArray[idx].callbackfunc(  ) ) 
    {
