...
extern void create_TouchThread();
extern void createPriceThread();
...
void   price :: onScreen(uint8_t showMeAt ) {
  ...
  switch ( showMeAt ) {
    ...
    case PRICE_Total       :  windowThree();   break;
    case PRICE_NetWeight   :  windowOne();   break;
  }
}
...
bool  price :: printStringPrice( ){
 ...
 char dateArray[10];
  ...
  tft.setCursor(260, 173);  tft.print("Total Price");
