...
static volatile int8_t ISR_Called = 0;
...
int8_t  WeighingHandle :: startWeighing()
{
  ...
  while (1)
  {
    //  SPL("Loop Wait : " + String(millis() - TimeOut) );
    //  TimeOut = millis();
