...
class WeighingHandle
{
  ...
  public :
    uint8_t flags;
    double weightFromMachine[3];
    char *weightFromMachineArrayGROSS = new char[10];
    char *weightFromMachineArrayNET =  new char[10];
    char *weightFromMachineArrayTARE =  new char[10];
    ...
    // Test Funcations
    void _updateNetWindow(  );
    void _updateGrossWeight( char *Temp );
    void _updateTareWeight( char *Temp );
    void _updateNetWeight( );

    void handleTareCommand( String temp );
    String handleFlags( String Weight );
    void  windowOne( );
    void  windowTwo( );
    void  windowThree( );
