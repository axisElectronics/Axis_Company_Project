...
int8_t autoZero( class settings *settings  )
{
  ...
  if ( tempStr == "kg" ) settings->userScaleSetup.WeighingUnits[kg] = 1;
  else if ( tempStr == "gm" ) settings->userScaleSetup.WeighingUnits[gm] = 1;
  else if ( tempStr == "Tons" ) settings->userScaleSetup.WeighingUnits[tons] = 1;
  else if ( tempStr == "Ounces(oz)" ) settings->userScaleSetup.WeighingUnits[Ounces] = 1;
  else if ( tempStr == "Pounds(lb)" ) settings->userScaleSetup.WeighingUnits[Pounds] = 1;
