...
void configFormats(struct _userInput *userInput )
{
    ...
    {
      case Date:
        getDate( userInput,  userInput->fixFormatstruct, "DD/MM/YY", strlen("DD/MM/YY") - 1, "/" );
      ...
      case Time:
        getTime( userInput,  userInput->fixFormatstruct, "HH:MM:SS", strlen("HH:MM:SS") - 1, ":" );
        noticBoard( userInput->noticBoard_FGColor, userInput->noticBoard_BGColor, userInput->fixFormatstruct->switchFlag );
        printkeypadLable( userInput );
        break;
    ...
    case Password :
     ...
     case stringType :
      if ( userInput->fixFormatstruct->idx < userInput->fixFormatstruct->maxLen )
      {
        ...
        else if(  userInput->fixFormatstruct->idx >= 17 )
        {
          moveUrDash( 15, userInput );
          userInput->fixFormatstruct->fixFormatArray[ userInput->fixFormatstruct->idx ] = temp;
          for(int8_t idx = 0, j = userInput->fixFormatstruct->idx - 17; idx < 16 ; idx++ , j++)
