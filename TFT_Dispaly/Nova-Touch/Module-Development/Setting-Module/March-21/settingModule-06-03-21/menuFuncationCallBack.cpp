...
int8_t saveAsDefault(  class settings *settings  )
{
  ...
  //5. calibration 
  SPL("decimal Value : " + String(settings->userSetting.decimalValue ) );
...
{
  enORDis( settings );
  settings->userSetting.weighingMode = 0;
  settings->userSetting.countingMode = 0;
  settings->userSetting.checkWeighing = 0;
  settings->userSetting.pricecomputing = 0;
