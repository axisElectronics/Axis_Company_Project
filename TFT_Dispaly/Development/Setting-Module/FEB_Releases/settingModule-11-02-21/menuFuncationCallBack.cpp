...
int8_t saveAsDefault( struct s_setting *basesetting )
{
  ...
  // 1. Application Setup
  basesetting->classOBJ_dftsett->userScaleSetup.application[WeighingMode] =  basesetting->userSetting->weighingMode;
  basesetting->classOBJ_dftsett->userScaleSetup.application[CountingMode] =  basesetting->userSetting->countingMode;
  basesetting->classOBJ_dftsett->userScaleSetup.application[CheckWeighing] = basesetting->userSetting->checkWeighing;
  basesetting->classOBJ_dftsett->userScaleSetup.application[PriceWeighing] = basesetting->userSetting->pricecomputing;
