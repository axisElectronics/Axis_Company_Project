...
#define Weight_CheckOut(Mode)  if( checkTouch(Mode) ) return -1;
#define Count_CheckOut(Mode)   if( checkTouch(Mode) ) return -1;
#define Price_CheckOut(Mode)   if( checkTouch(Mode) ) return -1;
#define Check_CheckOut(Mode)   if( checkTouch(Mode) ) return -1;
