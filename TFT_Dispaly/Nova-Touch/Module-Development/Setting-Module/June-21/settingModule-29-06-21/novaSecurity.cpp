...
//  kbd.userInput.fixFormatstruct->fieldType = stringType;
 kbd.userInput.fixFormatstruct->fieldType = Password;
  ...
  if ( strlen( _tempPassword ) >= minPasswordLength ) {
    ...
    case admin   : SPL("You are admin..!!");  faildAttemped=0; return admin;
    case service : SPL("You are Samart service Man..!!");  faildAttemped=0; return service;
    default : if ( ++faildAttemped < minPasswordRetryAttemped ) {
