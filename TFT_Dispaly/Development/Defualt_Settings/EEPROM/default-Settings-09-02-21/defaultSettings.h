...
/*********************************************************************************
  ...
  --------------------------------------------------
   @Calibaration :
     # evlaue address holds one byte of data -->> reg:[6]
     # decimal address holds one byte of data -->> reg:[7]
     # capacity hold only 10 bytes of data-->> reg:[8-17]
     # caliWeight holds only 10 bytes of data-->> reg:[18-27]
...
/*********************************************************************************
  ...
  --------------------------------------------------
   @Weighing Units :
     # Weighing Units holds only one byte data.reg:[28]   
*********************************************************************************/

#define weightingUnitsAddress  WeighingApplicationAddress
...
defaultSettings()
{
  ...
  if ( !EEPROM.begin(EEPROM_SIZE) )
  {
    ...
    int8_t _setWeightUnit( int8_t weightUnit );
