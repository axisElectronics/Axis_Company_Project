...
void  WeighingHandle :: startCountComputing()
{
  char src[12];
  char dest[10];
  ...
  while (1)
  {
    ...
    handleTouchFuncationality_COUNT();
...
void  WeighingHandle :: handleTouchFuncationality_COUNT()
{
...
void WeighingHandle :: _updateWeightPrice(  )
{
  ...
  if ( ( 6 - showDigits.dotPosition - dotpos) < 0 ){ dotpos = 0; showDigits.spclFlag=1; }
  else { dotpos = ( 6 - showDigits.dotPosition - dotpos); showDigits.spclFlag=0; }
...
void  WeighingHandle :: startWeighing()
{
  ...
  while (1)
  {
    ...
    handleTouchFuncationality_Weight();
...
void  WeighingHandle :: handleTouchFuncationality_Weight()
{
  uint16_t xAxis = 0, yAxis = 0;
  char src[12] = {0};
  if ( tft.getTouch(&xAxis, &yAxis) )
...
{
  int8_t leadingZero = 0;
   SPL("WindowTwo_showDigits.dotPosition : " + String(showDigits.dotPosition) );
