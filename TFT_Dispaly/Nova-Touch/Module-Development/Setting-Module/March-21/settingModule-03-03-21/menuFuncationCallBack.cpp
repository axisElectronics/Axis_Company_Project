...
int8_t saveAsDefault(  class settings *settings  )
{
  ...
  //3. Weighing Units
  settings->userScaleSetup.WeighingUnits[kg]     = settings->userSetting.WeigingUnits_kg+48;
  settings->userScaleSetup.WeighingUnits[gm]     = settings->userSetting.WeigingUnits_gm+48;
  settings->userScaleSetup.WeighingUnits[tons]   = settings->userSetting.WeigingUnits_t+48;
  settings->userScaleSetup.WeighingUnits[Ounces] = settings->userSetting.WeigingUnits_oz+48;
  settings->userScaleSetup.WeighingUnits[Pounds] = settings->userSetting.WeigingUnits_lb+48;
  ...
  SPL("save as default-WeighingUnits_1  : " + String( settings->userScaleSetup.WeighingUnits[tons] ) );
  settings->saveAsDefault();
  SPL("save as default-WeighingUnits_2  : " + String( settings->_getWeighingUnit() ) );
  return 1;
}
...
void readLoadcount( class settings *settings )
{
  ...
  settings->init(&settings->userInput );
  ...
  settings->takeUserInput( &settings->userInput, settings->userSetting.cali_weight );
...
int8_t decimalSetup(  class settings *settings )
{
  ...
  settings->takeUserInput( &settings->userInput, settings->userSetting.decimalValue );
...
int8_t eValueSetup(  class settings *settings )
{
  ...
  settings->takeUserInput( &settings->userInput, settings->userSetting.eValue );
...
int8_t capacitySetup( class settings *settings )
{
  ...
  settings->takeUserInput( &settings->userInput, settings->userSetting.scaleCapacity );
...
int8_t clockSetup(  class settings *settings )
{
  ...
  settings->takeUserInput( &settings->userInput, settings->userSetting.date );
...
int8_t setBaudrate( class settings *settings  )
{
  ...
  SPL( "Setting-Baudrate : " + String( settings->userSetting.Baudrate ) );
...
{
  enORDis( settings );
  settings->userSetting.weighingMode = ( settings->_getApplication() == "Weighing Mode" ) ? 1 : 0;
...
{
  enORDis( settings );
  settings->userSetting.countingMode = ( settings->_getApplication() == "Counting Mode" ) ? 1 : 0;
...
int8_t checkWeighing( class settings *settings )
{
  ...
  settings->userSetting.checkWeighing = ( settings->_getApplication() == "Check Weighing" ) ? 1 : 0;
...
int8_t priceComputing( class settings *settings )
{
  ...
  settings->userSetting.pricecomputing = ( settings->_getApplication() == "Price Weighing" ) ? 1 : 0;
